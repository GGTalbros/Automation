REM  delete the exist supp_automation folder then make all structure and copy files

if exist C:\Users\Administrator\Python_runnables\supp_automation (
  rmdir /s /q  "C:\Users\Administrator\Python_runnables\supp_automation" 
) else (
